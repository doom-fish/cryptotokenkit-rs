...
unsafe extern "C" {
    pub fn ctk_smart_card_atr_parse_bytes_json(data_ptr: *const u8, data_len: usize) -> *mut c_char;
    pub fn ctk_smart_card_atr_parse_source_json(
        callback: AtrSourceCallback,
        user_info: *mut c_void,
    ) -> *mut c_char;
    pub fn ctk_ber_tlv_record_json(tag: u64, value_ptr: *const u8, value_len: usize) -> *mut c_char;
