...
unsafe extern "C" {
    pub fn ctk_smart_card_slot(card: *mut c_void, error_out: *mut *mut c_char) -> *mut c_void;
    ...
    pub fn ctk_smart_card_user_interaction_clear_delegate(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    );
    pub fn ctk_smart_card_user_interaction_has_delegate(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> bool;
    ...
    pub fn ctk_smart_card_user_interaction_initial_timeout(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> f64;
    ...
    pub fn ctk_smart_card_user_interaction_interaction_timeout(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> f64;
    ...
    pub fn ctk_smart_card_user_interaction_cancel(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> bool;

    pub fn ctk_smart_card_pin_interaction_completion(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> u32;
    pub fn ctk_smart_card_pin_interaction_set_completion(
        interaction: *mut c_void,
        completion: u32,
        error_out: *mut *mut c_char,
    );
    ...
    pub fn ctk_smart_card_pin_interaction_result_sw(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> u16;
    pub fn ctk_smart_card_pin_interaction_result_data_json(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> *mut c_char;

    pub fn ctk_smart_card_pin_change_interaction_confirmation(
        interaction: *mut c_void,
        error_out: *mut *mut c_char,
    ) -> u32;
    ...
    pub fn ctk_smart_card_user_interaction_for_secure_pin_verification(
        ...
        out_interaction: *mut *mut c_void,
        error_out: *mut *mut c_char,
    ) -> i32;
