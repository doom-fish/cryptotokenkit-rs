# cryptotokenkit-rs coverage audit v2 (vs MacOSX26.2.sdk)
...
Enumerated all CryptoTokenKit framework public headers (14 .h files) from the macOS 26.2 SDK and cross-referenced every class, protocol, typedef, enum, property, and method against the crate's Rust public API and Swift bridge. The crate achieves 100% coverage of macOS-public symbols through its safe Rust wrappers and Swift bridge thunks. All exempt entries are marked as unavailable on macOS or deprecated with documented SDK attributes.
