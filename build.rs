...
fn main() {
    ...
    println!("cargo:rustc-link-lib=framework=CryptoTokenKit");
    ...
    let swift_triple = match target_arch.as_str() {
        ...
        other => panic!("cryptotokenkit-rs: unsupported target arch '{other}'"),
    };
...
{}",
    ...
    println!("cargo:rustc-link-lib=static=CryptoTokenKitBridge");
